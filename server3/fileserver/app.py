...
def getModel():
	result = {"model": "LanguageModel"}	# make this non-hardcoded (or maybe not)
...
def getEvalScore():
	result = {"score": 2.0}	# make this non-hardcoded (or maybe not)
...
if __name__ == '__main__':
	...
	app.run(threaded=True, debug=True, host='0.0.0.0', port=85)