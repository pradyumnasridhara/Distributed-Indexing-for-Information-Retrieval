...
def getModel():
	result = {"model": "ProbabilisticModel"}	# make this non-hardcoded (or maybe not)
...
def getEvalScore():
	result = {"score": 1.5}	# make this non-hardcoded (or maybe not)
...
if __name__ == '__main__':
	...
	app.run(threaded=True, debug=True, host='0.0.0.0', port=84)